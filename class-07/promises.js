...
//             // resolve(`food is ready (${status} / 1000)`);
...
// longTask('shawerma').then(resp => console.log('Task', resp)).catch(console.error);
...
//     console.log(data);
//     return longTask('c - 2');
// }).then(data => console.log(data)).then(error => { console.log(error); return longTask('c - 3'); })
